...
export function ResultsComponent() {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-primary text-shadow-lg text-shadow-black">
        Resultados Reais de Pacientes Reais
      </h2>
      <p className="text-2xl font-bold text-primary text-shadow-lg text-shadow-black mb-10">
      ...
      <div className="flex flex-col w-full p-4 text-center gap-6">
        <div className="bg-sidebar-primary p-4 rounded-2xl text-sidebar-foreground">
          ...
          <p className="flex justify-center items-center gap-4">
            <Check size={45} className="text-sidebar-primary-foreground" />
      ...
      <div className="flex w-full mt-14 p-4 text-center gap-6">
        <div className="text-sidebar-foreground w-1/4">
          <h4 className="text-primary text-shadow-lg text-shadow-black font-bold text-3xl mb-2">
            800+
          </h4>
